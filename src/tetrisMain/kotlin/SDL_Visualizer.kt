...
class SDL_Visualizer(val width: Int, val height: Int): GameFieldVisualizer, UserInput {
    ...
    private fun drawGamePad() {
        ...
        SDL_SetRenderDrawColor(renderer, 127.toUByte(), 127.toUByte(), 127.toUByte(), SDL_ALPHA_OPAQUE.toUByte())
        ...
        SDL_SetRenderDrawColor(renderer, 0.toUByte(), 0.toUByte(), 0.toUByte(), SDL_ALPHA_OPAQUE.toUByte())
    }
